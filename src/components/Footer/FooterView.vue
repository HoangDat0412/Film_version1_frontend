...
<template>
  <main>
    ...
    <hr>
    <footer class="main" style="margin-top: 70px;">
      <div class="fbox mt-3 mt-lg-4">
        <div class="fcmpbox">
          <div class="primary row">
            <div class="fotlogo col-12 col-lg-4">
              <div class="logo"><img width="100px" src="../../assets/logofilm.png" alt="">
              </div>
              <div class="text">
                <p>- Trang xem phim Online với giao diện mới được bố
                  trí và thiết kế thân thiện với người dùng. Nguồn phim được tổng hợp từ các website lớn với đa dạng các
                  đầu phim và thể loại vô cùng phong phú.</p>
              </div>
            </div>
            <div class="columenu col-12 col-lg-8 row justify-content-around mt-4 mt-lg-0">
              <div class="item  col-12 col-sm-4 d-flex justify-content-center">
                <div>
              ...
              <div class="item col-12 col-sm-4 d-flex justify-content-center">
                ...
                <ul>
                  <li><a @click="() => handleCountry(`Trung Quốc`)">Phim Trung Quốc</a></li>
                </ul>
                <ul>
                  <li><a @click="() => handleCountry(`Nhật Bản`)">Phim Nhật Bản</a></li>
                </ul>
                <ul>
                  <li><a @click="() => handleCountry(`Thái Lan`)">Phim Thái Lan</a></li>
                </ul>
                </div>
              </div>
              <div class="item col-12 col-sm-4 d-flex justify-content-center">
                <div>
                  <h4 style="color: rgb(255, 150, 88);">Thông tin</h4>
                <ul>
