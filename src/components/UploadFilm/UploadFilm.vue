...
<template>
    ...
    <form>
        <div className='form-group position-relative mb-2 mt-5'>
            <h5>Img</h5>
            <img :src="film.filmWatching?.imgurl" style="width: 100px; height: 120px;" alt="">
        </div>
        <div className='form-group position-relative mb-2'>
            <h5>Src</h5>
            <iframe class="metaframe rptss mt-4" :src="film.filmWatching?.srcurl" frameborder="0" scrolling="no" allow="encrypted-media"
                allowfullscreen="true" width="400px" height="250px"></iframe>
        </div>
        <div className='form-group position-relative mb-2'>
            <h5>Trailer</h5>
            <iframe class="metaframe rptss mt-4" :src="film.filmWatching?.trailerurl" frameborder="0" scrolling="no" allow="encrypted-media"
                allowfullscreen="true" width="400px" height="250px"></iframe>
        </div>
